...
from chatlib.helpers import expand_query, cosine_similarity_numpy, format_sources_for_html
...
# load chapter vectorstore summaries
...
def rag_retrieve(query: str, llm, global_retriever):
